...
import com.contentgrid.surveyor.infrastructure.collector.prometheus.transport.PrometheusMatrixResult;
import com.contentgrid.surveyor.infrastructure.collector.prometheus.transport.PrometheusResult;
import com.contentgrid.surveyor.infrastructure.collector.prometheus.transport.PrometheusResultAssembler;
import com.contentgrid.surveyor.infrastructure.collector.prometheus.transport.PrometheusVectorResult;
...
public class PrometheusMeasurementCollector implements MeasurementCollector {
    ...
    public PrometheusMeasurementCollector(WebClient.Builder clientBuilder, ObjectMapper objectMapper,
    ...
    private Flux<CollectedMeasurement> handleAssembly(MetricCollectionConfig config,
    ...
    private Flux<CollectedMeasurement> toMetrics(MetricCollectionConfig config, PrometheusResult data) {
    ...
    private CollectedMeasurement createMetric(MetricCollectionConfig config,
